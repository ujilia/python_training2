...
class test_add_contact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="fsff", middlename="fsf", lastname="fsdf", nickname="sdff", title="dsfdsf", company="fsfdfdf", address="4242", home="3424", mobile="2344", work="4234",
